  ...
  try {
    ...
    switch (reportType) {
      case 'users':
        ...
        data = usersData || []
        headers = [
          'id', 'display_name', 'user_tier', 'subscription_status',
          'onboarding_completed', 'created_at', 'available_credits', 'total_credits_earned'
        ]
        break
      ...
      case 'leads':
        ...
        data = leadsData || []
        headers = [
          'id', 'email', 'name', 'company', 'tier_interest', 'status',
          'source', 'lead_score', 'notes', 'created_at', 'follow_up_date'
        ]
        break
      ...
      case 'mfa_entries':
        ...
        data = mfaData || []
        headers = [
          'id', 'user_id', 'name', 'require_password', 'share_token', 'created_at', 'updated_at'
        ]
        break
      ...
      case 'revenue':
        ...
        data = revenueData || []
        headers = [
          'id', 'user_id', 'event_type', 'amount', 'currency',
          'subscription_plan', 'billing_period', 'created_at'
        ]
        break
