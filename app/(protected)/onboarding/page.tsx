...
export default function OnboardingPage() {
      ...
      <div className="min-h-screen bg-gradient-neutral bg-neutral-texture flex items-center justify-center">
        ...
        >
          <div className="text-center glass-neutral p-8 rounded-2xl">
            ...
            <TextEffect per="char" preset="fade-in-blur" className="text-lg text-slate-700">
  ...
  const renderStep = () => {
    switch (currentStep) {
      ...
      case 2:
        return <ProfileSetupStep onNext={handleProfileSetup} onBack={handleStepBack} initialData={onboardingData} />;
      case 3:
        return (
          <CompletionStep
