          ...
          >
            <Card className="surface-elevated p-8">
              <div className="text-center py-12">
                ...
                <p className="text-sm text-slate-500">Basic analytics are available in the main dashboard.</p>
              </div>
            </Card>
          </InView>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              <Card className="surface-elevated p-6">
                ...
                <div className="text-center py-8 text-slate-400">Chart placeholder</div>
              </Card>
            </InView>
            ...
            >
              <Card className="surface-elevated p-6">
                <h3 className="text-lg font-semibold text-slate-900 mb-4">Usage Patterns</h3>
                <div className="text-center py-8 text-slate-400">Chart placeholder</div>
              </Card>
            </InView>
          </div>
