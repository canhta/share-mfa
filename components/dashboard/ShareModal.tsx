        ...
        {!shareData ? (
          <div className="space-y-5">
            <Alert variant="warning">
              <strong>Security Warning:</strong> Sharing MFA codes can compromise security. Only share with trusted individuals and use password protection.
            </Alert>
            ...
            <div className="space-y-4">
              <Checkbox
                ...
                onChange={(checked) => setShareSettings(prev => ({ ...prev, requirePassword: checked }))}
              />
              ...
              {shareSettings.requirePassword && (
                <>
                  <Checkbox
                    ...
                    onChange={(checked) => setShareSettings(prev => ({ ...prev, embedPasswordInLink: checked }))}
                  />
