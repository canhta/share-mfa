...
export default function MfaEntryCard({ entry, currentCode, timeRemaining, onDelete }: MfaEntryCardProps) {
  ...
  return (
    <>
      ...
      >
        <Card hover variant="elevated" className="transition-all duration-200 relative overflow-hidden">
          <GlowEffect
            className="opacity-5"
          ...
          <div className="relative z-10">
            ...
            {entry.notes && (
              <p className="text-sm text-muted-foreground mb-4 line-clamp-2">{entry.notes}</p>
            )}
