      ...
      {!shareData ? (
        <div className="space-y-5">
          <Alert variant="warning">
            <strong>Security Warning:</strong> Sharing MFA codes can compromise
            security. Only share with trusted individuals and use password
            protection.
          </Alert>
          ...
          <ModalActions>
            ...
            <Button
              ...
              disabled={
                loading ||
                (shareSettings.requirePassword && !shareSettings.password)
              }
              loading={loading}
            >
              Generate Share Link
          ...
          <Alert variant="success">
            ...
            {shareSettings.embedPasswordInLink && (
              <span className="block mt-1 font-medium">
                Warning: Password is embedded in the URL and may be visible in
                logs.
              </span>
            )}
          </Alert>
