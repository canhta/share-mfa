  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="mt-1 text-sm text-gray-500">Overview of your ShareMFA platform performance and health.</p>
      </div>
      ...
      {analytics && (
        <div className="grid grid-cols-1 gap-5 lg:grid-cols-2">
          ...
          <div className="bg-white overflow-hidden shadow rounded-lg">
            <div className="p-6">
              <h3 className="text-lg leading-6 font-medium text-gray-900 mb-4">User Tier Distribution</h3>
          ...
          <div className="bg-white overflow-hidden shadow rounded-lg">
            <div className="p-6">
              <h3 className="text-lg leading-6 font-medium text-gray-900 mb-4">Lead Pipeline</h3>
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-600">Total Leads</span>
                  <span className="text-sm font-semibold text-gray-900">{analytics.leadAnalytics.total}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-600">New</span>
                  <span className="text-sm font-semibold text-blue-600">{analytics.leadAnalytics.new}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-600">Contacted</span>
                  <span className="text-sm font-semibold text-yellow-600">{analytics.leadAnalytics.contacted}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-600">Converted</span>
                  <span className="text-sm font-semibold text-green-600">{analytics.leadAnalytics.converted}</span>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="p-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span
                    className={`text-sm font-semibold ${stats.unreadAlerts > 0 ? 'text-red-600' : 'text-green-600'}`}
                  >
                    {stats.unreadAlerts}
                  </span>
                </div>
