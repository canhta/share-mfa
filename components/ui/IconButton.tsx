...
export default function IconButton({
  ...
  const variants = {
    ...
    ghost: ['bg-transparent hover:bg-gray-100/60', 'text-gray-400 hover:text-gray-600'],
    outline: [
      'bg-transparent hover:bg-gray-50/80',
      'border border-gray-300 hover:border-gray-400',
      'text-gray-600 hover:text-gray-800',
    ],
    destructive: ['bg-transparent hover:bg-gray-100/60', 'text-gray-400 hover:text-gray-600'],
  };
