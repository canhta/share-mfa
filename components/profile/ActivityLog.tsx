      ...
      <Card className="p-6">
        ...
        {error && (
          <div className="text-center text-red-600 py-4">
            <p>{error}</p>
            <Button variant="outline" size="sm" onClick={fetchActivityLog} className="mt-2">
              Try Again
            </Button>
          </div>
        )}
        ...
        <div className="flex items-start space-x-3">
          ...
          <div>
            ...
            <p className="text-sm text-blue-800 mt-1">
              We track important account activities for security purposes. If you notice any suspicious activity, please
