  ...
  return (
    <Card className="p-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-3">
            <label className="flex items-center">
              <input
                ...
                onChange={(e) => handleInputChange('product_updates_consent', e.target.checked)}
                disabled={loading}
        ...
        <div className="pt-6 border-t border-gray-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
            <div>
              ...
              <span className="ml-2 font-medium capitalize">{profile.user_tier}</span>
            </div>
            <div>
              <span className="text-gray-500">Available Credits:</span>
              <span className="ml-2 font-medium">{profile.available_credits}</span>
            </div>
            <div>
              <span className="text-gray-500">Total Credits Earned:</span>
              <span className="ml-2 font-medium">{profile.total_credits_earned}</span>
            </div>
            <div>
        ...
        {/* Submit Button */}
        <div className="pt-6">
          <Button type="submit" disabled={loading || !hasChanges()} className="flex items-center">
