            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-sm text-blue-700">
                  Secure sharing of multi-factor authentication codes
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="space-y-3">
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                Your passwords should be at least 12 characters long and unique
                for each service.
              </p>
            </div>
          </div>
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                Only share MFA codes with trusted recipients and use password
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                Periodically review your shared links and revoke access when no
                longer needed.
              </p>
            </div>
          </div>
