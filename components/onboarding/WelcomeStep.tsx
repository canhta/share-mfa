    ...
    <div className="text-center">
      <div className="mb-8">
        ...
        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          The secure way to store and share your multi-factor authentication codes.
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-8">
        {features.map((feature) => {
          ...
          return (
            <div key={feature.title} className="text-left p-4 rounded-lg border border-gray-200 hover:border-blue-300 transition-colors">
