...
const features = [
  {
    ...
    description:
      "Store your MFA codes securely with enterprise-grade encryption",
  },
  {
    icon: Share2,
    title: "Easy Sharing",
    ...
    <div className="text-center">
      <div className="mb-8">
        ...
        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          The secure way to store and share your multi-factor authentication
          codes. Never lose access to your accounts again.
        </p>
      </div>
